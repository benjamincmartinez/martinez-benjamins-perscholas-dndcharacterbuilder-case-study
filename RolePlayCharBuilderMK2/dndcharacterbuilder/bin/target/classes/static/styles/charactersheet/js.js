...
function noviceCalc(e){
    ...
    let statreference = document.getElementById(e.previousSibling.textContent).value;
    if(statreference > 0){
        e.value = Math.floor((statreference - 10) * 0.5) ;
    }
}
    ...
    for(let i = 0; i < document.getElementsByClassName('proficiencyCircleNone').length; i++){
        ...
        document.getElementById(pc).addEventListener('click', event =>{
            if(document.getElementById(pc).className == 'proficiencyCircleNone'){
                ...
                proficientCalc(document.getElementById(pc).parentElement.nextSibling.nextSibling);
                //document.getElementById(pc).parentElement.nextSibling.nextSibling.value = 5;
                // console.log(document.getElementById(pc).parentElement.nextSibling.nextSibling.textContent = 'okay');
                document.getElementById(pc).parentElement.nextSibling.nextSibling.nextSibling.textContent = 
                document.getElementById(pc).parentElement.nextSibling.nextSibling.value;
            }
                ...
                expertCalc(document.getElementById(pc).parentElement.nextSibling.nextSibling);
                document.getElementById(pc).parentElement.nextSibling.nextSibling.nextSibling.textContent =
                document.getElementById(pc).parentElement.nextSibling.nextSibling.value;
            }
                ...
                noviceCalc(document.getElementById(pc).parentElement.nextSibling.nextSibling);
                document.getElementById(pc).parentElement.nextSibling.nextSibling.nextSibling.textContent =
                document.getElementById(pc).parentElement.nextSibling.nextSibling.value;
            }
        })
